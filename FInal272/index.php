...
//echo $type;
		...
		$q1 = "SELECT p.productid,p.categoryid,p.description,p.price,p.name,AVG(r.star) AS rating_average FROM product_data p INNER JOIN review r ON r.productid = p.productid GROUP BY p.productid ORDER BY rating_average DESC LIMIT 5";
        $ok = $conn->query($q1);
  ...
  $q1 = "select * from product_data p,orders o,ordermap om where p.productid=om.productid and om.orderid=o.orderid group by p.productid order by o.created desc limit 6";
    ...
    $q1 = "select * from product_data,(select p.productid,sum(om.quantity) as total from product_data p,orders o ,ordermap om where p.productid=om.productid and om.orderid=o.orderid group by p.productid order by total desc) as result where product_data.productid=result.productid limit 6";
    $ok = $conn->query($q1);
    $index8=0;
    while($row = mysqli_fetch_array($ok))
    {
    ...
    <section id="facts">
      <div class="container wow fadeIn">
        ...
        <div class="row counters">
          ...
          <?php
            include('mysql.php');
            $sql="select count(reviewid) as count from review";
            $ok = $conn->query($sql);
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p>Spartan MarketPlace,<br>1 Washington Sqaure<br>San Jose, CA 95110</p>
              </div>

              <div>
                <i class="fa fa-envelope"></i>
                <p>umangkakaiya@sjsu.edu</p>
              </div>
...
window.onclick = function(event) {
    ...
    <div class="container">
      <div class="copyright">
      <a href="https://twitter.com/intent/tweet?button_hashtag=LoveSpartanMarketPlace&ref_src=twsrc%5Etfw" class="twitter-hashtag-button" data-show-count="false">
		Tweet #LoveSpartanMarketPlace</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
      <br>

...
<div class="container">
  ...
  <nav id="nav-menu-container">
    <ul class="nav-menu">
      ...
      <li class="menu-has-children"><a href="product_page.php?categoryid=1">Back</a>
      </li>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <?php echo '<img src="img/travel/'.($coming).'.jpg" alt="" style="width:100%; height: 425px; margin:20px;margin-top:0px">'; ?>
                      ...
                      <?php
                      include('mysql.php');
                      $sql = "SELECT r.productid,AVG(r.star) AS star FROM review r,product_data p where p.productid=r.productid and p.name='".$coming."' GROUP BY r.productid";
                      //echo $sql;
                      $ok = $conn->query($sql);
                      ...
                      ?>
                        <?php
                          include('mysql.php');
                          $sql = "select count(*) as count from review r, product_data p where p.productid=r.productid and p.name='".$coming."'";
